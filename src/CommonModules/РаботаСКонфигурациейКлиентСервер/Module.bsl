...
//  МетаданныеКВыгрузке - Неопределено, Строка - Путь к файлу метаданных, если нет пути - выгрузка полная
...
Функция КомандаДляЗапускаВыгрузкиОбъектовIBCMD(ПараметрыВыполнения, ПараметрыКонфигурации, ИмяФайлаМетаданные = Неопределено, Рекурсивно = Ложь) Экспорт
